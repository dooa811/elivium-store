    ...
    <div>
      ...
      <section className="section-pad">
        <div className="container-xl">
          <Reveal className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 mb-14">
            ...
            <Link
              to="/shop?tag=new"
              className="btn-outline-gold text-xs px-7 py-3 flex-shrink-0"
            >
              View All New →
            </Link>
          </Reveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -right-6 bg-gold-500 p-6 hidden sm:block">
                  <p className="font-display text-3xl font-bold text-obsidian-900">
                    12+
                  </p>
                  <p className="text-xs font-semibold uppercase tracking-wider text-obsidian-700 mt-1">
                    Years of Excellence
                  </p>
                </div>
              </div>
            ...
            <Reveal delay={0.2}>
              ...
              <p className="text-gray-400 font-light leading-relaxed mb-5">
                Elivium was founded on a single conviction: that clothing should
                be more than what you wear — it should express who you are. Every
                piece in our collection is sourced from the finest ateliers and
                crafted with the highest standards of quality.
              </p>
              <p className="text-gray-400 font-light leading-relaxed mb-8">
                We partner with sustainable suppliers across Europe and Asia,
                ensuring every garment you wear carries a story of craftsmanship,
                integrity, and beauty.
              </p>
              <Link to="/about" className="btn-gold text-xs px-8 py-3.5 inline-block">
                Discover Our Story
              </Link>
            </Reveal>
          </div>
      ...
      <section className="section-pad relative overflow-hidden">
        <div className="absolute inset-0">
          <img src={newin} alt="CTA" className="w-full h-full object-cover opacity-20" />
        ...
        <div className="container-xl relative z-10 text-center">
          <Reveal>
            ...
            <p className="text-gray-400 font-light text-lg mb-10 max-w-xl mx-auto">
              Explore our full collection of over 100 exceptional pieces — each
              one ready to become a staple of your wardrobe.
            </p>
